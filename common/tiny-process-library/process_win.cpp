...
Process::id_type Process::open(const string_type &command, const string_type &path,bool hidden) noexcept {
  if(open_stdin)
  ...
  BOOL bSuccess = CreateProcess(nullptr, process_command.empty()?nullptr:&process_command[0], nullptr, nullptr, TRUE, hidden ? CREATE_NO_WINDOW : 0,
