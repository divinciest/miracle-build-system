...
public:
  ...
  Process(const string_type &command, const string_type &path=string_type(),
          ...
          size_t buffer_size=131072,bool=false) noexcept;
#ifndef _WIN32
  ...
  bool StartedOk(){return StartSucess.load();}
private:
  Data data;
  bool closed;
  ...
  bool open_stdin;
  std::atomic<bool> StartSucess;
  std::mutex stdin_mutex;
  size_t buffer_size;

  std::unique_ptr<fd_type> stdout_fd, stderr_fd, stdin_fd;

  id_type open(const string_type &command, const string_type &path,bool=false) noexcept;
#ifndef _WIN32
